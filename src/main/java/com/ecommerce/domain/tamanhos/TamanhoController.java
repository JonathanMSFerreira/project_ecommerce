...
public class TamanhoController {
    ...
    public ResponseEntity get() {
    	...
    	List<Tamanho> carrinhos = service.getTamanhos();
    ...
    public ResponseEntity get(@PathVariable("id") Long id) {
    	...
    	Tamanho tamanhos = service.getTamanhoById(id);
...
//    }
    ...
    @PostMapping
    @Secured({ "ROLE_ADMIN" })
    public ResponseEntity post(@RequestBody Tamanho tamanho) {

    	Tamanho c = service.insert(tamanho);
